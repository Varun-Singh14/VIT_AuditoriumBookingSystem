package com.helloworld.vitauditoriumbookingsys.HomeAdapter.Categories;
...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.CategoriesViewHolder> {
    ...
    final private ListItemClickListener pOnClickListener;

    private CategoriesViewHolder holder;

    public CategoriesAdapter(ArrayList<CategoriesHelperClass> categories, ListItemClickListener listener) {
        this.categories = categories;
        this.pOnClickListener = listener;
    }
    ...
    public CategoriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CategoriesViewHolder categoriesViewedViewHolder = new CategoriesViewHolder(view);
        return categoriesViewedViewHolder;
    }
    ...
    public interface ListItemClickListener {
        void onCategoriesListClick(int clickedItemIndex);
    }
    ...
    public class CategoriesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            pOnClickListener.onCategoriesListClick(clickedPosition);
        }
    }
