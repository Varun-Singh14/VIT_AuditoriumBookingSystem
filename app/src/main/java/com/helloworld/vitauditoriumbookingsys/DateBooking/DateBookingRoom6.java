...
public class DateBookingRoom6 extends AppCompatActivity {
    ...
    DatabaseReference booking_roomF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(DateBookingRoom6.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int day) {
                                ...
                                booking_roomF.addValueEventListener(new ValueEventListener() {
                                    @Override
        ...
        booking_roomF = database.getReference("RoomF");
        ...
        btnbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog mDialog = new ProgressDialog(DateBookingRoom6.this);
                ...
                booking_roomF.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        mDialog.dismiss();
                        RoomF roomF = new RoomF(usrRegno.getText().toString(),usrName.getText().toString(),titleEvent.getText().toString(),
                                descEvent.getText().toString(),stTime.getText().toString(),etTime.getText().toString(), "pending");
                        booking_roomF.child(etDate.getText().toString()).setValue(roomF);
    ...
    public void endTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom6.this, onTimeSetListener, ethour, etminute, true);
    ...
    public void startTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom6.this, onTimeSetListener, sthour, stminute, true);
        timePickerDialog.show();
    }

    public void alert(String message){
        AlertDialog dlg = new AlertDialog.Builder(DateBookingRoom6.this)
                .setTitle("Error")
                .setMessage(message)
