...
public class DateBookingRoom4  extends AppCompatActivity {
    ...
    DatabaseReference booking_roomD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(DateBookingRoom4.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int day) {
                                ...
                                booking_roomD.addValueEventListener(new ValueEventListener() {
                                    @Override
        ...
        booking_roomD = database.getReference("RoomD");
        ...
        btnbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog mDialog = new ProgressDialog(DateBookingRoom4.this);
                ...
                booking_roomD.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        mDialog.dismiss();
                        RoomD roomD = new RoomD(usrRegno.getText().toString(),usrName.getText().toString(),titleEvent.getText().toString(),
                                descEvent.getText().toString(),stTime.getText().toString(),etTime.getText().toString(), "pending");
                        booking_roomD.child(etDate.getText().toString()).setValue(roomD);
    ...
    public void endTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom4.this, onTimeSetListener, ethour, etminute, true);
    ...
    public void startTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom4.this, onTimeSetListener, sthour, stminute, true);
        timePickerDialog.show();
    }

    public void alert(String message){
        AlertDialog dlg = new AlertDialog.Builder(DateBookingRoom4.this)
                .setTitle("Error")
                .setMessage(message)
