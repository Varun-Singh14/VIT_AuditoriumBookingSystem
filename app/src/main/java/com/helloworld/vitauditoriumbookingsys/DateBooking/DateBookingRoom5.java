...
public class DateBookingRoom5  extends AppCompatActivity {
    ...
    DatabaseReference booking_roomE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(DateBookingRoom5.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int day) {
                                ...
                                booking_roomE.addValueEventListener(new ValueEventListener() {
                                    @Override
        ...
        booking_roomE = database.getReference("RoomE");
        ...
        btnbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog mDialog = new ProgressDialog(DateBookingRoom5.this);
                ...
                booking_roomE.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        mDialog.dismiss();
                        RoomE roomE = new RoomE(usrRegno.getText().toString(),usrName.getText().toString(),titleEvent.getText().toString(),
                                descEvent.getText().toString(),stTime.getText().toString(),etTime.getText().toString(), "pending");
                        booking_roomE.child(etDate.getText().toString()).setValue(roomE);
    ...
    public void endTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom5.this, onTimeSetListener, ethour, etminute, true);
    ...
    public void startTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom5.this, onTimeSetListener, sthour, stminute, true);
        timePickerDialog.show();
    }

    public void alert(String message){
        AlertDialog dlg = new AlertDialog.Builder(DateBookingRoom5.this)
                .setTitle("Error")
                .setMessage(message)
