...
public class DateBookingRoom2  extends AppCompatActivity {
    ...
    DatabaseReference booking_roomB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(DateBookingRoom2.this,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker view, int year, int month, int day) {
                                ...
                                booking_roomB.addValueEventListener(new ValueEventListener() {
                                    @Override
        ...
        booking_roomB = database.getReference("RoomB");
        ...
        btnbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog mDialog = new ProgressDialog(DateBookingRoom2.this);
                ...
                booking_roomB.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        mDialog.dismiss();
                        RoomB roomB = new RoomB(usrRegno.getText().toString(),usrName.getText().toString(),titleEvent.getText().toString(),
                                descEvent.getText().toString(),stTime.getText().toString(),etTime.getText().toString(),"pending");
                        booking_roomB.child(etDate.getText().toString()).setValue(roomB);
    ...
    public void endTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom2.this, onTimeSetListener, ethour, etminute, true);
    ...
    public void startTimePicker(View view) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(DateBookingRoom2.this, onTimeSetListener, sthour, stminute, true);
        timePickerDialog.show();
    }

    public void alert(String message){
        AlertDialog dlg = new AlertDialog.Builder(DateBookingRoom2.this)
                .setTitle("Error")
                .setMessage(message)
